...
using MaterialsProviderSimple = ArcadeCorsa.Render.DarkRenderer.Materials.MaterialsProviderSimple;
...
namespace ArcadeCorsa.Render.DarkRenderer {
    public partial class DarkKn5ObjectRenderer : ForwardRenderer, IKn5ObjectRenderer {
        ...
        public DarkKn5ObjectRenderer(CarObject car, ShowroomObject showroom = null) {
            _car = car;
            _showroom = showroom;
        ...
        private void ClearExisting() {
            if (_car != null) {
                var existing = _previousCars.FirstOrDefault(x => x.Id == _car.Id);
                if (existing != null) {
        ...
        public void SelectSkin(string skinId) {
            if (CarNode == null || _loadingCar != null) {
                _selectSkin = skinId;
